...
runcmd:
  ...
  - rm -f /etc/cloud/cloud.cfg.d/91_ephemeral.cfg #cloud-config
  ...
  # Configure NVIDIA UVM to disable HMM (fixes RTX 5090 stability issues)
  - echo "options nvidia_uvm uvm_disable_hmm=1" > /etc/modprobe.d/uvm.conf
  - update-initramfs -u
